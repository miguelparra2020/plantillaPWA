    ...
    <div className="container">
      {[...Array(20)].map((_, i) => (
        <Particle
          key={i}
          delay={i * 100}
          startY={typeof window !== 'undefined' ? window.innerHeight * 0.6 + Math.random() * 100 : 0}
        />
      ))}
      ...
      <div className="titleContainer" style={{ opacity: titleOpacity }}>
        <h1 className="title">
          ...
          {dataLanguaje.languajeChoose === "/fr/" ? generalConfig.Create.wellcome.fr.titleWellcome : ""}
        </h1>
        <h2 className="subtitle">
          ...
          {dataLanguaje.languajeChoose === "/fr/" ? generalConfig.Create.wellcome.fr.subtitleWellcome : ""}
        </h2>
      </div>
    </div>
  );
