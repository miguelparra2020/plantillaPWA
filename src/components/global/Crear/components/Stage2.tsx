...
const Stage2 = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      return (
        <div className="mt-4 group relative overflow-hidden w-[96%] max-w-md bg-white border border-zinc-200  rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)]  min-h-[600px] flex flex-col justify-between gap-2">
          <div className="p-4 flex items-center justify-between border-b border-zinc-200 ">
            <div className="flex items-center gap-3">
              <div>
                <h3 className="text-sm font-medium text-zinc-900 ">
                 Etapa:2 Bienvenido a la creación personalizada del comercio eletrónico
                </h3>
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            {error && (
              <div className="m-4 px-4 py-3 flex items-center gap-2 text-sm text-red-600  bg-red-50  rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-zinc-500">Nombre de su ecommerce</span>
                    </div>
                    <Input
                      type="text"
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={settings.language} onValueChange={(value) => handleSettingsChange("language", value)}>
                      <SelectTrigger className="z-10 w-full h-10 bg-zinc-100  border-zinc-200  rounded-xl">
                    ...
                    <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
                      <CardContent className="flex flex-col items-center gap-4 p-6">
                        ...
                        <div className="space-y-1 text-center">
                          <p className="text-sm font-medium text-zinc-700 ">Creando su ecommerce...</p>
                          <p className="text-xs text-zinc-500 ">Esto puede tomar unos segundos</p>
                        </div>
                        <div className="w-full h-1.5 bg-zinc-200  rounded-full overflow-hidden">
                          <div className="h-full bg-fuchsia-500 transition-all duration-300 ease-linear w-[60%]"></div>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="p-3 space-y-2 bg-zinc-50  rounded-xl">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-zinc-900 ">{settings.language}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-zinc-500">Estado</span>
                          <span className="text-zinc-900 ">Activo</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <button
                          ...
                          className="w-full h-10 flex items-center justify-center gap-2 border border-zinc-200  text-zinc-900 text-sm font-medium rounded-xl hover:bg-zinc-50  transition-colors"
                        >
                          Volver a editar
                        </button>
                        <button
