                    ...
                    <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
                      <CardContent className="flex flex-col items-center gap-4 p-6">
                        ...
                        <div className="space-y-1 text-center">
                          <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Creando su ecommerce...</p>
                          <p className="text-xs text-zinc-500 dark:text-zinc-400">Esto puede tomar unos segundos</p>
                        </div>
